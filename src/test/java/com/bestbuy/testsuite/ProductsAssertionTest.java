...
public class ProductsAssertionTest {
    ...
    //  11. Verify the if the total is equal to 15957
    @Test
    public void test011() {
    ...
    @Test
    public void test019(){
       // response.body("id", equalTo(333179));
        Arrays.asList("data[8].id",equalTo(333179));
    }
    //20. Verify the prodctId = 346575 have 5 categories//x.data[9].categories
    @Test
    public void test20(){
        Arrays.asList("data[9].catrgories",equalTo(5));
    }
